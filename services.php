...
<main>
  <section>
    <div class="service-page">
      ...
      <div class="serv-btn">
        <button class="btn" onclick="layout_one()">Bookkeeping</button>
        <button class="btn" onclick="layout_two()">Payroll</button>
        <button class="btn" onclick="layout_three()">Administration</button>
      </div>
      <div class="container">
        <div class="row serv_tog">
          <div class="col-6 info_one" id="block_1">
            <img src="images/bridge.jpg" atl="image of a bridge" width="300px" height="200px">
          </div>
          <div class="col-6 info_two" id="block_2">
